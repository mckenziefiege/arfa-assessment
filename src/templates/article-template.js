...
class ArticleTemplate extends Component {
  state = {
    likes: parseInt(localStorage.getItem(this.props.data.contentfulStory.slug))
  }

  likeArticle = () => {
    let num = parseInt(localStorage.getItem(this.props.data.contentfulStory.slug))
    localStorage.setItem(this.props.data.contentfulStory.slug, num + 1)
    this.setState({
      likes: num + 1
    })
  }
    ...
    return (
      <div className="chosen-article">
        ...
        <div className="chosen-article__likes-container">
          <p className="chosen-article__likes">{localStorage.getItem(slug)}</p>
